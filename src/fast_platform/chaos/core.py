...
class ChaosExperiment:
    ...
    def __init__(
        ...
        Args:
            ...
            failures: The failures parameter.
            abort_conditions: The abort_conditions parameter.
        ...
        self._metrics = {"requests": 0, "failures": 0, "latencies": []}
    ...
    async def run(self) -> ExperimentResult:
        ...
        try:
            ...
            injection_tasks = [self._inject_failure(failure) for failure in self.failures]
    ...
    async def _generate_result(self) -> ExperimentResult:
        ...
        return ExperimentResult(
            ...
            error_rate=(self._metrics["failures"] / max(self._metrics["requests"], 1)),
        )
...
class ChaosRegistry:
    ...
    def register(cls, experiment: ChaosExperiment) -> None:
        ...
        Args:
            experiment: The experiment parameter.
...
class ChaosController:
    ...
    @classmethod
    async def start_experiment(cls, name: str, dry_run: bool = False) -> Optional[ExperimentResult]:
    ...
    def list_experiments(cls) -> List[Dict[str, Any]]:
        ...
        return [
            {"name": name, "target": exp.target, "status": exp.status.name}
