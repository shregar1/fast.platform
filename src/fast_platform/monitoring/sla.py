...
class SLA:
    ...
    def __init__(
        ...
        Args:
            ...
            sla_type: The sla_type parameter.
            target: The target parameter.
            window: The window parameter.
            alert_threshold: The alert_threshold parameter.
        """
        self.name = name
    ...
    def record(self, value: float) -> SLAMetric:
        ...
        metric = SLAMetric(value=value, timestamp=datetime.utcnow(), target=self.target, met=met)
    ...
    def _cleanup_old(self) -> None:
        ...
        self._measurements = [m for m in self._measurements if m.timestamp.timestamp() > cutoff]
...
def track_sla(
    name: str, sla_type: SLAType = SLAType.LATENCY, target: float = 99.9, window: str = "30d"
):
