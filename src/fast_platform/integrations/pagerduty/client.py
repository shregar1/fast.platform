...
class PagerDutyClient:
    ...
    def __init__(self, api_token: str, default_service_id: Optional[str] = None):
        ...
        Args:
            api_token: The api_token parameter.
            default_service_id: The default_service_id parameter.
        """
    ...
    async def trigger_incident(
        ...
        if description:
            payload["incident"]["body"] = {"type": "incident_body", "details": description}

        async with session.post("https://api.pagerduty.com/incidents", json=payload) as response:
    ...
    async def resolve_incident(self, incident_id: str) -> bool:
        ...
        async with session.put(
            f"https://api.pagerduty.com/incidents/{incident_id}", json=payload
        ) as response:
    ...
    async def get_incident(self, incident_id: str) -> Optional[PagerDutyIncident]:
        ...
        async with session.get(f"https://api.pagerduty.com/incidents/{incident_id}") as response:
...
def trigger_incident(
    title: Optional[str] = None, service_id: Optional[str] = None, urgency: str = "high"
):
