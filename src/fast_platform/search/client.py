...
class SearchClient(ABC):
    ...
    async def create_index(self, name: str, options: Dict[str, Any]) -> None:
        """Execute create_index operation.
    ...
    @abstractmethod
    async def add_documents(self, index: str, documents: List[Dict[str, Any]]) -> None:
    ...
    @abstractmethod
    async def update_documents(self, index: str, documents: List[Dict[str, Any]]) -> None:
        """Execute update_documents operation.
    ...
    async def delete_document(self, index: str, document_id: str) -> None:
        """Execute delete_document operation.

        Args:
            index: The index parameter.
            document_id: The document_id parameter.
    ...
    @abstractmethod
    async def search(self, index: str, query: str, options: Dict[str, Any]) -> Dict[str, Any]:
...
class TypesenseClient(SearchClient):
    ...
    def __init__(self, api_key: str, nodes: List[Dict[str, str]]):
        """Execute __init__ operation.
    ...
    def _get_client(self):
        ...
        if self._client is None:
            try:
                ...
                self._client = typesense.Client({"api_key": self.api_key, "nodes": self.nodes})
            except ImportError:
    ...
    async def create_index(self, name: str, options: Dict[str, Any]) -> None:
        ...
        """
        client = self._get_client()
        schema = {"name": name, "fields": options.get("fields", []), **options}
        try:
    ...
    async def search(self, index: str, query: str, options: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        client = self._get_client()
        search_params = {"q": query, "query_by": options.get("query_by", "*"), **options}
...
class ElasticsearchClient(SearchClient):
    ...
    async def search(self, index: str, query: str, options: Dict[str, Any]) -> Dict[str, Any]:
        ...
        client = self._get_client()
        body = {
            "query": {"multi_match": {"query": query, "fields": options.get("fields", ["*"])}},
            **options,
        }
