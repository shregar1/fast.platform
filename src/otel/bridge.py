"""
Trace context propagation aligned with :func:`utils.request_id_context.get_request_id`.
...
def _trace_api():
    mod, _ = optional_import("opentelemetry.trace")
    return mod
...
def inject_trace_context_into_carrier(carrier: MutableMapping[str, str]) -> bool:
    ...
    """
    prop_mod, _ = optional_import("opentelemetry.trace.propagation.tracecontext")
    ctx_mod, _ = optional_import("opentelemetry.context")
