...
class NotificationRetryPolicyDTO(BaseModel):
    """
    ...
    def to_dataclass(self) -> NotificationRetryPolicy:
    ...
    @classmethod
    def from_dataclass(cls, policy: NotificationRetryPolicy) -> NotificationRetryPolicyDTO:
        return cls(
...
class PushNotificationTarget(BaseModel):
...
class NotificationFanoutRequest(BaseModel):
    """
