...
class IMedia(ABC):
    """Marker base for concrete types in the ``media`` package."""
...
class IImageVariantGenerator(IMedia, ABC):
...
__all__ = ["IMedia", "IMediaStore", "IImageVariantGenerator", "UploadResult"]
