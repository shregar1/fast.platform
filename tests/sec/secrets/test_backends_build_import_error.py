...
class TestBackendsBuildImportError(ISecretsTests):
    def test_build_secrets_backend_import_error_returns_none(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        class FakeCfg:
            def __init__(self) -> None:
                ...
                self.aws = types.SimpleNamespace(
                    enabled=True, region="us-east-1", access_key_id=None, secret_access_key=None, prefix="p"
                )
