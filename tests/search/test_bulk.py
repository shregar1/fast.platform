...
def test_bulk_index_success_and_errors() -> None:
    b = FlakyBackend(fail_batches={1})
...
def test_bulk_index_stop_on_error() -> None:
    b = FlakyBackend(fail_batches={0})
...
def test_bulk_index_batch_size_invalid() -> None:
    b = FlakyBackend(fail_batches=set())
