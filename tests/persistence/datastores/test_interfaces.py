...
class TestInterfaces(IDatastoresTests):
    """Represents the TestInterfaces class."""

    def test_idatastore_cannot_instantiate(self) -> None:
        """Execute test_idatastore_cannot_instantiate operation.
    ...
    def test_ikey_value_store_cannot_instantiate(self) -> None:
        """Execute test_ikey_value_store_cannot_instantiate operation.
    ...
    def test_idocument_store_cannot_instantiate(self) -> None:
        """Execute test_idocument_store_cannot_instantiate operation.
    ...
    def test_irelational_database_cannot_instantiate(self) -> None:
        """Execute test_irelational_database_cannot_instantiate operation.
    ...
    def test_iwide_column_store_cannot_instantiate(self) -> None:
        """Execute test_iwide_column_store_cannot_instantiate operation.
    ...
    def test_isearch_store_cannot_instantiate(self) -> None:
        """Execute test_isearch_store_cannot_instantiate operation.
