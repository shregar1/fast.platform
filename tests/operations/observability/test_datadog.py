...
from fast_platform.operations.observability.datadog import configure_datadog
...
class TestConfigureDatadog(IObservabilityTests):
    ...
    @patch("fast_platform.operations.observability.datadog.DatadogConfiguration")
    ...
    def test_sets_env_when_enabled(self, mock_dc: MagicMock) -> None:
        ...
        with patch("fast_platform.operations.observability.datadog.os.environ", fake_env):
            configure_datadog()
