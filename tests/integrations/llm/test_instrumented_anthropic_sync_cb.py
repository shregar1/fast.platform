...
class TestInstrumentedAnthropicSyncCb(ILLMTests):
    ...
    async def test_instrumented_anthropic_emits_usage(self) -> None:
        ...
        def fake_init(self: Any, api_key: str, base_url: Any, model: str, *, on_token_usage: Any=None) -> None:
            self._model = model
    ...
    async def test_instrumented_openai_async_callback(self) -> None:
        ...
        def fake_init(self: Any, api_key: str, base_url: Any, model: str, *, on_token_usage: Any=None, usage_provider: str='openai') -> None:
            self._model = model
            self._client = mock_client
            self._on_token_usage = on_token_usage
