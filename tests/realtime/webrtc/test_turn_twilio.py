...
class TestTurnTwilio(IWebRTCTests):
    ...
    def test_fetch_twilio_turn_ice_servers_parses_response(self, mock_urlopen):
        payload = {'ice_servers': [{'urls': 'stun:global.stun.twilio.com:3478'}, {'urls': 'turn:global.turn.twilio.com:3478?transport=udp', 'username': 'u', 'credential': 'p'}]}
    ...
    def test_fetch_twilio_turn_http_error(self, mock_urlopen):
        ...
        mock_urlopen.side_effect = HTTPError('https://api.twilio.com/x', 401, 'Unauthorized', {}, fp)
