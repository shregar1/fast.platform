...
class TestBackendsFactoryImportError(ISearchTests):
    def test_build_search_backend_import_error_returns_none(self, monkeypatch) -> None:
        ...
        sys.modules.pop("data_platform.search.meilisearch_backend", None)
        sys.modules.pop("data_platform.search.typesense_backend", None)
        sys.modules.pop("data_platform.search.opensearch_backend", None)
