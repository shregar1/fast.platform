...
class TestBackends(IStorageTests):
    ...
    def test_is_storage_backend_abstract_methods_and_presigned_url(self):
        ...
        class DummyBackend(IStorageBackend):
            ...
            def upload(self, key: str, body: bytes | BinaryIO, *, content_type: Optional[str]=None, metadata: Optional[dict[str, str]]=None) -> str:
    ...
    def test_storage_factory_success_builds_s3_gcs_and_azure(self, monkeypatch, tmp_path):
        ...
        sys.modules['google.cloud.storage'] = fake_storage_mod
        fake_blob_service_client = types.SimpleNamespace(from_connection_string=lambda connection_string: types.SimpleNamespace(get_container_client=lambda container: object()))
    ...
    def test_s3_backend_upload_download_delete_and_presigned_url(self, monkeypatch):
        ...
        sys.modules['boto3'] = fake_boto3
        backend = S3StorageBackend(bucket='bucket', base_path='base', region='us-east-1', endpoint_url='http://endpoint', access_key_id='ak', secret_access_key='sk')
    ...
    def test_azure_blob_backend_upload_download_delete(self, monkeypatch, tmp_path):
        ...
        class FakeBlobClient:
            ...
            def get_blob_properties(self):
                ...
                return types.SimpleNamespace(size=2, content_settings=cs, etag='e1', last_modified=None)
    ...
    def test_azure_blob_backend_account_url_branch_and_missing_args(self, monkeypatch):
        ...
        class FakeBlobServiceClient:
            ...
            def __init__(self, *args, **kwargs):
                self._container = types.SimpleNamespace(get_blob_client=lambda key: types.SimpleNamespace(upload_blob=lambda *a, **k: None, url='https://blob/url', download_blob=lambda: types.SimpleNamespace(readall=lambda: b'')), delete_blob=lambda key: None)
