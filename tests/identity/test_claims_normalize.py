...
def test_normalize_roles_keycloak_style():
    claims = {
...
def test_normalize_token_claims_mfa():
    claims = {
        "sub": "user-1",
        "iss": "https://idp/",
        "aud": "my-api",
